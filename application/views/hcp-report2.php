<head>
  <meta name="viewport" content="width=1024">
    <title>HCP Consultant-POST EVENT REPORT</title>
  <link
    rel="stylesheet"
...
<body style="font-size:13px">
    <div class="container-fluid" style="border:1px solid black;padding-left:22px;padding-right:8px;padding-bottom:8px;padding-top:8px;width:927px">
      ...
      ?>
    <form action="<?php echo base_url().'index.php/HCPReport2/add'; ?>" method="post"> 
      <div class="row">
      ...
      <div class="row">
        <div class="col-xs-1" style="background:#efefef;text-align:center;width:910px">
          <b>HCP CONSULTANT-POST EVENT REPORT</b>
        </div>
      </div>
      <div class="row">
        ...
        <span style="background:#efefef;"><?php echo substr($created_date,-4);?>/R-HCPC/<?php echo date("m",strtotime($created_date));?>/</span><div class="col-xs-1" style="height:30px;background:#efefef;width:447px">
		...
		<div class="col-xs-1">
		  <div class="form-group">
			<textarea rows="2" class="form-control" id="event_name" name="event_name" readonly
			  style="height:60px;width:190px;"><?php echo $event_name; ?></textarea>
		  </div>
		</div>
      ...
      <div class="row" style="height:38px;">
        ...
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1" style="width:700px">
          <div class="form-group">
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="border-right:1px solid black;width:200px;height:30px;">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <input type="hidden" id="id_hcp" name="id_hcp" value="<?php echo $_GET['id_hcp']; ?>">
...
//    alert("#speciality_temp").val();
    ...
    if($("#id_group").val()==6 && $("#state").val()==1 && $("#id_parent").val()!=null)
    {
      ...
      request_approval.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPReport2/updateState?id_hcp="+<?php echo $_GET['id_hcp']; ?>+"&id_mer="+<?php echo $_GET['id_mer']; ?>+"&id_group="+<?php echo $_GET['access']; ?>+"&id="+id_sc,
              type: "GET",
              dataType: "text",
      ...
      if($("#state").val()>=2)
      {
		  ...
		  {		  
			  $.ajax({
				url: "<?php echo base_url(); ?>index.php/HCPReport2/updateState5?id_hcp="+<?php echo $_GET['id_hcp']; ?>+"&id_mer="+<?php echo $_GET['id_mer']; ?>+"&id_group="+<?php echo $_GET['access']; ?>+"&id="+id_sc,
				  type: "GET",
				  dataType: "text",
				  success: function(response){
				},
    ...
    if(($("#id_group").val()==12 && $("#state").val()==2))
    {
      ...
      review.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPReport2/updateState2?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
					Swal.fire({
      ...
      freeze.onclick = function() 
      {
		  ...
		  ?>
		   $.ajax({
				url: "<?php echo base_url(); ?>index.php/HCPReport2/updateState4?active="+active+"&id="+id_sc,
				type: "GET",
				dataType: "text",
				success: function(response){
					if(active==0)
      ...
      reject.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPReport2/updateState3?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
				Swal.fire({
...
//    if(($("#id_group").val()==7 || $("#id_group").val()==8 || $("#id_group").val()==9 || $("#id_group").val()==10) && $("#state").val()==1)
    ...
    function deleteAttachment(id)
    {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCPReport2/deleteAttachment?id="+id,
          type: "GET",
          dataType: "text",
          success: function(response){
            $.ajax({
              url: "<?php echo base_url(); ?>index.php/HCPReport2/getAttachment?id="+id_sc+"&state="+<?php echo $state; ?>,
                type: "GET",
                dataType: "text",
              success: function(response){
                  $('#attachment').html(response);
					...
					$.ajax({
					  url: "<?php echo base_url(); ?>index.php/HCPReport2/getListAttachment?id="+id_sc,
						type: "GET",
						dataType: "text",
					  success: function(response){
...
//		}
      ...
      $('#upload').bind('click', function(){
          ...
          $.ajax({
              url : "<?php echo base_url(); ?>index.php/HCPReport2/upload",
              type : 'POST',
              data : data,
              contentType: false,
              processData: false,
