...
$(function()
{
	$("input[placeholder='Search ID']").hide();
	$("input[placeholder='Search Identity']").hide();
	$("input[placeholder='Search Sales']").hide();
	$("input[placeholder='Search Customer Master']").hide();
