...
<body style="font-size:13px">
    ...
    ?>
        <form action="<?php echo base_url().'index.php/AgreementLetter2/add'; ?>" method="post"> 
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-1" style="background:#efefef;text-align:center;width:650px">
                    <b>SPEAKER AGREEMENT LETTER - HCP CONSULTANT</b>
                </div>
            </div>
            <div class="row">
                ...
                <span style="background:#efefef;"><?php echo substr($created_date,-4);?>/SA/<?php echo date("m",strtotime($created_date));?>/</span><div class="col-xs-1" style="height:30px;background:#efefef;width:337px">
            ...
            <div class="row" style="height:68px;">
				...
				<div class="col-xs-1">
				  <div class="form-group">
					<textarea rows="2" class="form-control" id="event_title" name="event_title"
					  style="height:60px;width:350px;"><?php echo $event_title; ?></textarea>
				  </div>
				</div>
            </div>
            <div class="row" style="height:68px;">
				...
				<div class="col-xs-1">
				  <div class="form-group">
					<textarea rows="2" class="form-control" id="event_description" name="event_description"
					  style="height:60px;width:350px;"><?php echo $event_description; ?></textarea>
				  </div>
				</div>
            </div>
            <div class="row" style="height:68px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:220px">Fee</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
				<div class="col-xs-1">
				  <div class="form-group">
					<textarea rows="2" class="form-control" id="fee" name="fee"
					  style="height:60px;width:350px;"><?php echo $fee; ?></textarea>
				  </div>
				</div>
            </div>
            <div class="row" style="height:38px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:220px">HCP</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <div class="col-xs-1">
                    <div class="form-group">
            ...
            <div class="row" style="height:30px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:220px">Waktu</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <div class="col-xs-1">
                    <div class="form-group">
            ...
            <a type="button" href="<?php echo base_url(); ?>assets/uploads/AgreementLetter-<?php echo substr($created_date,-4);?>-SA-<?php echo date("m",strtotime($created_date));?>-<?php echo $nodoc2; ?>.docx?t=<?php echo time(); ?>" id="download" class="btn btn-primary btn-sm">Download File</a>
...
<script type="text/javascript">    
    ...
    $(function () 
    {
        ...
        if($("#id_group").val()==11 || $("#id_group").val()==5 || $("#id_group").val()==12)
        {
