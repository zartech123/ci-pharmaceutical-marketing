<head>
    <title>THANK YOU LETTER - HCP Consultant</title>
...
<body style="font-size:13px">
    ...
    <div class="container-fluid">
        <form action="<?php echo base_url().'index.php/ThankLetter3/add'; ?>" method="post"> 
             <div class="row">
            ...
            <div class="row">
                <div class="col-xs-1" style="background:#efefef;text-align:center;width:650px">
                    <b>THANK YOU LETTER - HCP Consultant</b>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row" style="height:68px;">
                <div class="col-xs-1" style="width:220px">Rumah Sakit</div>
            ...
            <a type="button" href="<?php echo base_url(); ?>assets/uploads/ThankYouLetter-HCPC-<?php echo substr($created_date,-4);?>-TL-<?php echo date("m",strtotime($created_date));?>-<?php echo $nodoc2; ?>.docx?t=<?php echo time(); ?>" id="download" class="btn btn-primary btn-sm">Download File</a>
