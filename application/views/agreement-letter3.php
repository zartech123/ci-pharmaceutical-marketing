<head>
    ...
    <title>SPEAKER AGREEMENT LETTER - TPI</title>
...
//		echo $doctor."xxxx";
    ...
    ?>
        <form action="<?php echo base_url().'index.php/AgreementLetter3/add'; ?>" method="post"> 
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-1" style="background:#efefef;text-align:center;width:650px">
                    <b>SPEAKER AGREEMENT LETTER - TPI</b>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row" style="height:68px;">
				...
				<div class="col-xs-1">
				  <div class="form-group">
					<textarea rows="2" class="form-control" id="fee" name="fee" readonly
            ...
            <a type="button" target="_blank" href="<?php echo base_url(); ?>assets/uploads/AgreementLetter-SERF-<?php echo substr($created_date,-4);?>-SA-<?php echo date("m",strtotime($created_date));?>-<?php echo $nodoc2; ?>.docx?t=<?php echo time(); ?>" id="download" class="btn btn-primary btn-sm">Download File</a>
