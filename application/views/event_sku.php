...
$(function()
{
		...
		$("#field-cust_cost_actual").css("width","240");
		$("#field-dist_cost_actual").css("width","240");
		$("#field-cust_cost").css("width","240");
		$("#field-dist_cost").css("width","240");
		$("#field-qty_est").css("width","240");
		$("#field-qty_actual").css("width","240");
});
</script>
</html>
