...
<body style="font-size:13px">
    <div class="container-fluid">
        <form action="<?php echo base_url().'index.php/OfferLetter/add'; ?>" method="post"> 
            <div class="row">
            ...
            <div class="row" style="height:30px;">
                ...
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <?php echo substr($created_date,-4);?>/HCP1/<?php echo date("m",strtotime($created_date));?>/<div class="col-xs-1">
                    <div class="form-group">
            ...
            <div class="row" style="height:38px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:170px">Rumah Sakit</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <div class="col-xs-1">
            ...
            <div class="row" style="height:30px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:170px">Jumlah</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <div class="col-xs-1">
                    <div class="form-group">
                        <input class="form-control" id="hcp" name="hcp" type="text" style="width:40px" maxlength="3"  value="<?php echo $hcp; ?>" readonly/>
                    </div>
                </div>
            </div>
            <div class="row" style="height:68px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:170px">Fasilitas</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
				<div class="col-xs-1">
				  <div class="form-group">
            ...
            <div class="row">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
            <div class="col-xs-1" style="width:170px">Spesialisasi</div>
            <div class="col-xs-1">&nbsp;:&nbsp;</div>
            <div class="col-xs-1">
            ...
            <div class="row">
                <div class="col-xs-1" style="width:190px"></div>
                <div class="col-xs-1">&nbsp;&nbsp;&nbsp;</div>
                <div class="col-xs-1">
                    <div class="form-group">
            ...
            <div class="row" style="height:60px;">
                <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
                <div class="col-xs-1" style="width:170px">Kota</div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
				<div class="col-xs-1">
				  <div class="form-group">
        ...
        <a type="button" href="<?php echo base_url(); ?>assets/uploads/OfferLetter-<?php echo substr($created_date,-4);?>-HCP1-<?php echo date("m",strtotime($created_date));?>-<?php echo $nodoc2; ?>.docx?t=<?php echo time(); ?>" id="download" class="btn btn-primary btn-sm">Download File</a>
...
//	}
    ...
    $.ajax({
		url: "<?php echo base_url(); ?>index.php/MER/getSpeciality2?id_hcp1="+<?php echo $_GET['id_hcp1'];  ?>,
			type: "GET",
			dataType: "text",
		success: function(response){
			var json = $.parseJSON(response);
