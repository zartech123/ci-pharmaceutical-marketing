<head>
    ...
    <title>THANK YOU LETTER - HCO</title>
...
<body style="font-size:13px">
    <div class="container-fluid">
        <form action="<?php echo base_url().'index.php/ThankLetter2/add'; ?>" method="post"> 
             <div class="row">
            ...
            <div class="row" style="height:68px;">
                ...
                <div class="col-xs-1" style="width:220px"><b>Organiation</b></div>
                <div class="col-xs-1">&nbsp;:&nbsp;</div>
                <div class="col-xs-1">
                    <div class="form-group">
						<textarea rows="2" class="form-control" id="event_institution" name="event_institution" readonly
            ...
            <a type="button" href="<?php echo base_url(); ?>assets/uploads/ThankYouLetter-HCO-<?php echo substr($created_date,-4);?>-TL-<?php echo date("m",strtotime($created_date));?>-<?php echo $nodoc2; ?>.docx?t=<?php echo time(); ?>" id="download" class="btn btn-primary btn-sm">Download File</a>
