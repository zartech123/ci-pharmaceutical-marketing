  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><strong>HCP SPONSORSHIP REQUEST FORM 2</strong></h5>
      </div>
...
$(function()
{
		...
		$("input[name='action']").after();
//		$("input[name='action']").after("<a id='create' href='HCPC' target='_blank' class='btn btn-primary btn-xs' style='width:130px'><i class='fa fa-plus'></i>&nbsp;&nbsp;HCP Consultant</a>");
