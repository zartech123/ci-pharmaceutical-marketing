	...
	<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
	  ...
	  <div class="modal-content">
	      ...
	      <div class="modal-body">
	          <form class="form col-md-12 center-block" action="<?=base_url();?>index.php/Login/changepassword" method="post">
	            ...
	            <div class="form-group">
	              <button class="btn btn-primary btn-block" type="submit">Reset Password</button><br>
...
$("form").submit(function( event ) {
  if ($("input[name='password1']").val()!="" && $("input[name='password2']").val()!="" && $("input[name='code']").val()!="") 
  {	
