...
<body style="font-size:13px">
    <div class="container-fluid" style="border:1px solid black;padding-left:22px;padding-right:8px;padding-bottom:8px;padding-top:8px;width:927px">
      ...
      ?>
    <form action="<?php echo base_url().'index.php/HCP2/add'; ?>" method="post"> 
        <div class="row">
      ...
      <div class="row">
        <div class="col-xs-1" style="background:#efefef;text-align:center;width:910px">
          <b>HCP SPONSORSHIP REQUEST FORM 2</b>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-1" style="background:#efefef;text-align:center;width:910px">
          <b>(FOR INDIVIDUAL PARTICIPANT)</b>
        </div>
      </div>
      <div class="row">
        ...
        <span style="background:#efefef;"><?php echo substr($created_date,-4);?>/HCP2/<?php echo date("m",strtotime($created_date));?>/</span><div class="col-xs-1" style="height:30px;background:#efefef;width:451px">
      ...
      <div class="row" style="height:38px;">
        ...
        <div class="col-xs-1" style="width:210px;"><b>Type</b></div>
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1">
          <div class="form-group">
            <select class="form-control" id="location" name="location" style="height:30px">
        ...
        <div class="col-xs-1">
          <div class="form-group">
            <textarea rows="2" class="form-control" id="event_organizer" name="event_organizer" readonly
              style="height:60px;width:280px;"><?php echo $event_organizer; ?></textarea>
		  </div>
        </div>
        <div class="col-xs-1" style="width:18px">&nbsp;</div>
        <div class="col-xs-1" style="width:108px"><b>HCP SRF 1</b></div>
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1"><?php echo substr($created_date3,-4);?>/HCP1/<?php echo date("m",strtotime($created_date3));?>/</div>
        <div class="col-xs-1">
          <div class="form-group">
              <input class="form-control" id="nodoc" name="nodoc" type="text" style="width:165px" value="<?php echo $nodoc3; ?>" readonly/>
          </div>
        </div>
      </div>
      <div class="row" style="height:68px;">
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="local_amount4" name="local_amount[]" class="form-control" type="text" value="<?php echo $$local_amount_text; ?>"
              style="width:150px;height:30px;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount4" name="foreign_amount[]" class="form-control" type="text" value="<?php echo $$foreign_amount_text; ?>"
              style="width:150px;height:30px;" />
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xs-1"
          style="width:200px;text-align:center;border-bottom:1px solid black;border-left:1px solid black;height:90px">
        </div>
          <div class="col-xs-1" style="width:200px">
            <div class="form-group">
              <textarea
        ...
        <input type="hidden" id="list_facility" value="">
        ...
        <input type="hidden" id="id_hcp1" name="id_hcp1" value="<?php echo $_GET['id_hcp1']; ?>">
...
<script type="text/javascript">
	...
	if($("#state").val()==6 && ($("#id_group").val()==11 || $("#id_group").val()==5 || $("#id_group").val()==4 || $("#id_group").val()==7))
	{
    ...
    if($("#id_group").val()==7 && $("#state").val()==1 && $("#id_parent").val()!=null)
    {
      ...
      request_approval.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCP2/updateState?id_hcp1="+<?php echo $_GET['id_hcp1']; ?>+"&id_mer="+<?php echo $_GET['id_mer']; ?>+"&id_group="+<?php echo $_GET['access']; ?>+"&id="+id_sc,
              type: "GET",
              dataType: "text",
...
//      $("#approve").attr("style", "visibility:show");
      ...
      review.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCP2/updateState2?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
					Swal.fire({
      ...
      freeze.onclick = function() 
      {
		  ...
		  ?>
		   $.ajax({
				url: "<?php echo base_url(); ?>index.php/HCP2/updateState4?active="+active+"&id="+id_sc,
				type: "GET",
				dataType: "text",
				success: function(response){
					if(active==0)
      ...
      reject.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCP2/updateState3?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
				Swal.fire({
    ...
    if(($("#id_group").val()==7 || $("#id_group").val()==8 || $("#id_group").val()==9 || $("#id_group").val()==10) && $("#state").val()==1)
    {
      ...
      save.onclick = function() 
      {
        ...
        if($("#room").val().trim()=="" && $("#list_facility").val().includes("Accommodation"))
        {
        ...
        if($("#event_institution").val()==null)
        {
		  ...
		  error_text = error_text+"<br>Please select the Event of Institution";
          error = "1";
        }
        ...
        if($("#event_start_date1").val().trim()=="" && $("#list_facility").val().includes("Travel"))
        {
          $("#event_start_date1").css('border','1px solid #ff0000');
		  error_text = error_text+"<br>Please fill the Depart Date";
          error = "1";
        }
        if($("#event_end_date1").val().trim()=="" && $("#list_facility").val().includes("Travel"))
        {
          $("#event_end_date1").css('border','1px solid #ff0000');
		  error_text = error_text+"<br>Please fill the Return Date";
          error = "1";
        }
        if (($.datepicker.parseDate('dd/mm/yy', $("#event_start_date1").val()) > $.datepicker.parseDate('dd/mm/yy', $("#event_end_date1").val())) && $("#list_facility").val().includes("Travel")) 
        {
          $("#event_start_date1").css('border','1px solid #ff0000');
          error = "1";
		  error_text = error_text+"<br>Return Date can't be earlier than Depart Date";
        }        
        if($("#event_start_date2").val().trim()=="" && $("#list_facility").val().includes("Accommodation"))
        {
          $("#event_start_date2").css('border','1px solid #ff0000');
		  error_text = error_text+"<br>Please fill the Check In Date";
          error = "1";
        }
        if($("#event_end_date2").val().trim()=="" && $("#list_facility").val().includes("Accommodation"))
        {
          $("#event_end_date2").css('border','1px solid #ff0000');
		  error_text = error_text+"<br>Please fill the Check Out Date";
          error = "1";
        }
        if (($.datepicker.parseDate('dd/mm/yy', $("#event_start_date2").val()) > $.datepicker.parseDate('dd/mm/yy', $("#event_end_date2").val())) && $("#list_facility").val().includes("Accommodation"))
        {
		  error_text = error_text+"<br>Check Out Date can't be earlier than Check In Date";
          $("#event_start_date2").css('border','1px solid #ff0000');
          error = "1";
        }        
        if($("#flight").val().trim()=="" && $("#list_facility").val().includes("Travel"))
        {
          $("#flight").css('border','1px solid #ff0000');
		  error_text = error_text+"<br>Please fill the Travel Type";
          error = "1";
        }
    ...
    function deleteAttachment(id)
    {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCP2/deleteAttachment?id="+id,
          type: "GET",
          dataType: "text",
          success: function(response){
            $.ajax({
              url: "<?php echo base_url(); ?>index.php/HCP2/getAttachment?id="+id_sc+"&state="+<?php echo $state; ?>,
                type: "GET",
                dataType: "text",
              success: function(response){
                  $('#attachment').html(response);
					$.ajax({
					  url: "<?php echo base_url(); ?>index.php/HCP2/getListAttachment?id="+id_sc,
						type: "GET",
						dataType: "text",
					  success: function(response){
    ...
    $(function () {
      ...
      if($("#id_group").val()>9 || $("#id_group").val()==6)
      {
        $("[id^=upload]").prop("disabled",true);
      }
...
//****
      ...
      <?php  } ?>
            ...
            $.ajax({
              url: "<?php echo base_url(); ?>index.php/HCP2/getFacility?id_hcp1="+<?php echo $_GET['id_hcp1']; ?>,
                type: "GET",
                dataType: "text",
              success: function(response){
                  $('#list_facility').val(response);
               },
              error: function(response)
              {
              },
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCP2/getDoctor",
          type: "GET",
          dataType: "text",
        success: function(response){
          var json = $.parseJSON(response);
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCP2/getMedicheck?id_doctor="+<?php echo $doctor; ?>,
              type: "GET",
              dataType: "text",
            success: function(response){
      ...
      $("#doctor").change(function(){
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCP2/getMedicheck?id_doctor="+doctor,
              type: "GET",
              dataType: "text",
            success: function(response){
              $("#medicheck").val(response);
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCP2/getBank",
          type: "GET",
          dataType: "text",
        success: function(response){
          var json = $.parseJSON(response);
...
//					alert(localArray[x-1]+" "+x);
      ...
      $('#upload').bind('click', function(){
          ...
          $.ajax({
              url : "<?php echo base_url(); ?>index.php/HCP2/upload",
              type : 'POST',
              data : data,
              contentType: false,
              processData: false,
