...
<body style="font-size:13px">
  <div class="container-fluid">
      <?php 
        ...
        {
          if($_GET['access']==4 && $state==2)
          {
            $readonly_note1="";
          }
          else if($_GET['access']==3 && $state==3)
          {
            $readonly_note2="";
          }
          else if($_GET['access']==16 && $state==4)
          {
            $readonly_note3="";
          }
        }
        else
        {
          ...
          if($this->session->userdata('id_group')==4 && $state==2)
          {
            $readonly_note1="";
          }
          else if($this->session->userdata('id_group')==3 && $state==3)
          {
            $readonly_note2="";
          }
          else if($this->session->userdata('id_group')==16 && $state==4)
          {
            $readonly_note3="";
          }
        }  
...
//          $readonly="readonly"; 
      ...
      ?>
    <form action="<?php echo base_url().'index.php/HCPC/add'; ?>" method="post"> 
        <div class="row">
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="width:180px">
              <input class="form-control" id="event_name" name="event_name" type="text" style="width:170px" value="<?php echo $event_name; ?>"/>
        </div>
      </div>
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
        ...
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1">
              <input class="form-control" id="event_organizer" name="event_organizer" type="text" style="width:170px" value="<?php echo $event_organizer; ?>"/>
        </div>
      </div>
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
        ...
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1">
              <input class="form-control" id="event_venue" name="event_venue" type="text" style="width:170px" value="<?php echo $event_venue; ?>"/>
        </div>
      </div>
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1">
          <div class="form-group">
              <input class="form-control" id="event_contact" name="event_contact" type="text" style="width:170px" value="<?php echo $event_contact; ?>"/>
          </div>
        </div>
      </div>
      <div class="row" style="height:38px;">
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1">
          <div class="form-group">
            <input class="form-control" id="payee" name="payee" type="text" style="width:170px" value="<?php echo $payee; ?>"/>
          </div>
        </div>
      </div>
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1">
          <div class="form-group">
            <input class="form-control" id="account_number" name="account_number" type="text" style="width:170px" value="<?php echo $account_number; ?>"/>
          </div>
        </div>
      </div>
      <div class="row" style="height:38px;">
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1">
          <div class="form-group">
            <input class="form-control" id="branch" name="branch" type="text" style="width:170px" value="<?php echo $branch; ?>"/>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
       ...
       <div class="row">
        ...
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;width:700px;text-align:center;border-right:1px solid black;">
              <textarea rows="3" class="form-control" id="reason" name="reason"
                style="height:90px;width:699px;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;"><?php echo $reason; ?></textarea>
        </div>
      </div>
     <div class="row">
        <div class="col-xs-1"
        ...
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="local_amount1" name="local_amount1" class="form-control" type="text" value="<?php echo $local_amount1; ?>"
              style="width:150px;height:30px;border-bottom:1px solid black;border-left:1px solid black;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount1" name="foreign_amount1" class="form-control" type="text" value="<?php echo $foreign_amount1; ?>"
              style="width:150px;height:30px;border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;" />
          </div>
        </div>
      </div>
        ...
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="local_amount2" name="local_amount2" class="form-control" type="text" value="<?php echo $local_amount2; ?>"
              style="width:150px;height:60px;border-bottom:1px solid black;border-left:1px solid black;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount2" name="foreign_amount2" class="form-control" type="text" value="<?php echo $foreign_amount2; ?>"
              style="width:150px;height:60px;border-bottom:1px solid black;border-left:1px solid black;border-right:1px solid black;" />
          </div>
        </div>
      </div>
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="width:400px">
          <div class="form-group">
            <input id="description3" name="description3" class="form-control" type="text" value="<?php echo $description3; ?>"
              style="width:400px;height:30px;border-left:1px solid black;border-top:1px solid black;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="local_amount3" name="local_amount3" class="form-control" type="text" value="<?php echo $local_amount3; ?>"
              style="width:150px;height:30px;border-left:1px solid black;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount3" name="foreign_amount3" class="form-control" type="text" value="<?php echo $foreign_amount3; ?>"
              style="width:150px;height:30px;border-left:1px solid black;border-right:1px solid black;" />
          </div>
        </div>
      </div>
      ...
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="border-left:1px solid black;width:200px">
            <input
              ...
              style="width:200px;border-right:1px solid black;border-top:1px solid black;height:30px"
            />
        </div>
        <div class="col-xs-1">
          <div class="form-group">
            <input id="description" name="description[]" class="form-control" type="text" value="<?php echo $$description_text; ?>"
              style="width:400px;height:30px;border-left:1px solid black;" />
          </div>
        </div>
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
        ...
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount" name="foreign_amount[]" class="form-control" type="text" value="<?php echo $$foreign_amount_text; ?>"
              style="width:150px;height:30px;border-left:1px solid black;border-right:1px solid black;" maxlength="9" />
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="row" style="height:30px">
          <div
            class="col-xs-1"
            style="border-left:1px solid black;border-top:1px solid black;width:150px;text-align:center;border-bottom:1px solid black;border-left:1px solid black;"
          >
            <div class="form-group">
          ...
          <div class="col-xs-1" style="width:150px">
            <div class="form-group">
              <input
                ...
                style="width:150px;border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;border-top:1px solid black;"
              />
            </div>
          </div>
          <div class="col-xs-1" style="width:150px">
            <div class="form-group">
              <input
                ...
                style="width:150px;border-bottom:1px solid black;border-right:1px solid black;border-top:1px solid black;"
              />
            </div>
          </div>
          <div class="col-xs-1" style="width:150px">
      ...
      <div class="row">
        ...
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;width:200px;text-align:center">
          &nbsp;Business Operation<br />(<?php  if($state>2)  { echo $updated_date1;  } ?>)&nbsp;
        </div>
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;width:200px;text-align:center">
          &nbsp;Commercial Director<br />(<?php  if($state>3)  { echo $updated_date2;  } ?>)&nbsp;
        </div>
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;width:200px;text-align:center">
          &nbsp;Operational Director<br />(<?php  if($state>4)  { echo $updated_date3;  } ?>)&nbsp;
        </div>
      </div>
      <div class="row">
        <div class="col-xs-1"
          style="width:200px;text-align:center;border-bottom:1px solid black;border-right:1px solid black;height:90px">
          <br>Medical<br />(<?php echo $created_date;   ?>)&nbsp;
        </div>
          <div class="col-xs-1" style="width:200px">
            <div class="form-group">
              <textarea
                ...
                style="height:90px;width:200px;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;"
          ...
          <div class="col-xs-1" style="width:200px">
              <textarea rows="3" class="form-control" id="note3" name="note3" <?php echo $readonly_note3; ?>
                style="height:90px;width:200px;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;"><?php echo $note3; ?></textarea>
            </div>
          </div>
      </div>
        <div class="row">
        ...
        <button type="submit" id="request_approval" class="btn btn-success btn-sm" style="visibility:hidden">Request Approval</button>
        <button type="submit" id="review" class="btn btn-warning btn-sm" style="visibility:hidden">Review</button>
        <button type="submit" id="approve" class="btn btn-success btn-sm" style="visibility:hidden">Approve</button>
        <button type="submit" id="reject" class="btn btn-danger btn-sm" style="visibility:hidden">Reject</button>
        <button type="submit" id="freeze" class="btn btn-primary btn-sm" style="visibility:hidden">Freeze</button>
        <button type="button" id="print" style="visibility:hidden" class="btn btn-primary btn-sm" onclick="printPage();">Print</button>
...
<script type="text/javascript">
    ...
    if($("#id_group").val()==5 && $("#state").val()==1 && $("#id_parent").val()!=null)
    {
      <?php
        if(isset($_GET['id']))
        {
      ...
      request_approval.onclick = function() 
      {
        ...
        {
         $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPC/updateState?id_group="+<?php echo $_GET['access']; ?>+"&id="+id_sc,
              type: "GET",
              dataType: "text",
    ...
    if(($("#id_group").val()==4 && $("#state").val()==2) || ($("#id_group").val()==3 && $("#state").val()==3) || ($("#id_group").val()==16 && $("#state").val()==4))
    {
...
//      $("#approve").attr("style", "visibility:show");
      ...
      {
        if(($("#id_group").val()==4 && $("#note1").val()!="") || ($("#id_group").val()==3 && $("#note2").val()!="") || ($("#id_group").val()==16 && $("#note3").val()!=""))
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPC/updateState2?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
            },
      ...
      freeze.onclick = function() 
      {
		  ...
		  ?>
		   $.ajax({
				url: "<?php echo base_url(); ?>index.php/HCPC/updateState4?active="+active+"&id="+id_sc,
				type: "GET",
				dataType: "text",
				success: function(response){
					if(active==0)
      ...
      reject.onclick = function() 
      {
        ...
        {
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPC/updateState3?id="+id_sc,
              type: "GET",
              dataType: "text",
              success: function(response){
            },
...
//    if(($("#id_group").val()==7 || $("#id_group").val()==8 || $("#id_group").val()==9 || $("#id_group").val()==10) && $("#state").val()==1)
    ...
    function deleteAttachment(id)
    {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCPC/deleteAttachment?id="+id,
          type: "GET",
          dataType: "text",
          success: function(response){
            $.ajax({
              url: "<?php echo base_url(); ?>index.php/HCPC/getAttachment?id="+id_sc+"&state="+<?php echo $state; ?>,
                type: "GET",
                dataType: "text",
              success: function(response){
                  $('#attachment').html(response);
					...
					$.ajax({
					  url: "<?php echo base_url(); ?>index.php/HCPC/getListAttachment?id="+id_sc,
						type: "GET",
						dataType: "text",
					  success: function(response){
    ...
    $(function () {
      ...
      if($("#id_group").val()<=4 || ($("#id_group").val()>=5 && $("#state").val()>1))
      {
      ...
      if($("#id_group").val()>5 || $("#id_group").val()<=4)
      {
        $("[id^=upload]").prop("disabled",true);
      }
...
//****
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCPC/getDoctor",
          type: "GET",
          dataType: "text",
        success: function(response){
          var json = $.parseJSON(response);
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPC/getMedicheck?id_doctor="+<?php echo $doctor; ?>,
              type: "GET",
              dataType: "text",
            success: function(response){
      ...
      $("#doctor").change(function(){
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/HCPC/getMedicheck?id_doctor="+doctor,
              type: "GET",
              dataType: "text",
            success: function(response){
              $("#medicheck").val(response);
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>index.php/HCPC/getBank",
          type: "GET",
          dataType: "text",
        success: function(response){
          var json = $.parseJSON(response);
...
//****
      ...
      $('#upload').bind('click', function(){
          ...
          $.ajax({
              url : "<?php echo base_url(); ?>index.php/HCPC/upload",
              type : 'POST',
              data : data,
              contentType: false,
              processData: false,
