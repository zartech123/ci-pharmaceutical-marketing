<head>
  <meta name="viewport" content="width=1024">
    <title>HCP SPONSORSHIP REQUEST FORM 2</title>
    ...
    <form action="<?php echo base_url().'index.php/HCP/add'; ?>" method="post"> 
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="width:180px">
              <input class="form-control" id="event_name" name="event_name" type="text" style="width:170px" value="<?php echo $event_name; ?>" readonly/>
        </div>
        <div class="col-xs-1" style="width:118px">&nbsp;</div>
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1">
              <input class="form-control" id="event_organizer" name="event_organizer" type="text" style="width:170px" value="<?php echo $event_organizer; ?>" readonly/>
        </div>
      </div>
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
        ...
        <div class="col-xs-1">&nbsp;:&nbsp;</div>
        <div class="col-xs-1">
              <input class="form-control" id="event_venue" name="event_venue" type="text" style="width:170px" value="<?php echo $event_venue; ?>" readonly/>
        </div>
      </div>
      <div class="row" style="height:30px;">
        <div class="col-xs-1" style="width:20px">&nbsp;<i class="fa fa-square" aria-hidden="true"></i>&nbsp;</div>
        ...
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;width:700px;text-align:center;border-right:1px solid black;">
              <textarea rows="3" class="form-control" id="reason" name="reason"
                style="height:90px;width:699px;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;"><?php echo $note2; ?></textarea>
        </div>
      </div>
     <div class="row">
        <div class="col-xs-1"
      ...
      <div class="row" style="height:30px;">
        ...
        <div class="col-xs-1" style="width:150px">
          <div class="form-group">
            <input id="foreign_amount" name="foreign_amount[]" class="form-control" type="text" value="<?php echo $$foreign_amount_text; ?>"
              style="width:150px;height:30px;border-left:1px solid black;border-right:1px solid black;" maxlength="3" />
          </div>
        </div>
          <div class="col-xs-1" style="width:25px">
          <?php 
        ...
        <div class="col-xs-1" style="width:290px">
          <div class="form-group">
            <select class="form-control" id="file_type" style="height:30px">
              ...
              <option value="2">Permit Letter from Institution (Mandatory)</option>
            </select>
          </div>
        </div>
          <div class="col-xs-1">&nbsp;:&nbsp;</div>
      ...
      <div class="row">
        ...
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;width:200px;text-align:center">
          &nbsp;Medical<br />(<?php  if($state>2)  { echo $updated_date1;  } ?>)&nbsp;
        </div>
        <div class="col-xs-1"
          style="border-left:1px solid black;border-top:1px solid black;border-right:1px solid black;width:200px;text-align:center">
          &nbsp;Business Operation<br />(<?php  if($state>3)  { echo $updated_date2;  } ?>)&nbsp;
        </div>
      </div>
      <div class="row">
        <div class="col-xs-1"
          style="width:200px;text-align:center;border-bottom:1px solid black;border-right:1px solid black;height:90px">
          <br>Key Account Manager<br />(<?php  if($state>1)  { echo $created_date;  } ?>)&nbsp;
        </div>
          ...
          <div class="col-xs-1" style="width:200px">
            <div class="form-group">
              <textarea rows="3" class="form-control" id="note2" name="note2" <?php echo $readonly_note2; ?>
                style="height:90px;width:200px;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;"><?php echo $note2; ?></textarea>
            </div>
          </div>
      </div>
        <div class="row">
...
<script type="text/javascript">
    ...
    if(($("#id_group").val()==5 && $("#state").val()==2) || ($("#id_group").val()==4 && $("#state").val()==3))
    {
      ...
      $("#note1").css('border','1px solid #000000');
    ...
    if(($("#id_group").val()==7 || $("#id_group").val()==8 || $("#id_group").val()==9) && $("#state").val()==1)
    {
      ...
      {
        $("#product_percent1").css('border','1px solid #000000');
        $("#product_percent2").css('border','1px solid #000000');
        $("#product_percent3").css('border','1px solid #000000');
        $("#product_percent4").css('border','1px solid #000000');
        $("#nodoc2").css('border','1px solid #000000');
        $("#event_organizer").css('border','1px solid #000000');
        $("#event_name").css('border','1px solid #000000');
        $("#event_venue").css('border','1px solid #000000');
        $("#event_start_date").css('border','1px solid #000000');
        $("#event_end_date").css('border','1px solid #000000');
        $("#event_start_date1").css('border','1px solid #000000');
        $("#event_end_date1").css('border','1px solid #000000');
        $("#event_start_date2").css('border','1px solid #000000');
        $("#event_end_date2").css('border','1px solid #000000');
        $("#event_institution").css('border','1px solid #000000');
        $("#event_contact").css('border','1px solid #000000');
        $("#room").css('border','1px solid #000000');
        $("#flight").css('border','1px solid #000000');
        $("#payee").css('border','1px solid #000000');
        $("#branch").css('border','1px solid #000000');
        $("#bank").css('border','1px solid #000000');
        $("#account_number").css('border','1px solid #000000');
        $("#doctor").css('border','1px solid #000000');
        $("#medicheck").css('border','1px solid #000000');
        $("#file_type").css('border','1px solid #000000');
        $("[id^=local_amount]").css('border','1px solid #000000');
        $("[id^=foreign_amount]").css('border','1px solid #000000');
    ...
    $(function () {
      ...
      if($("#id_group").val()<=5 || ($("#id_group").val()==7 && $("#state").val()>1))
      {
      ...
      if($("#id_group").val()>7 || $("#id_group").val()==6)
      {
        $("[id^=upload]").prop("disabled",true);
      }
