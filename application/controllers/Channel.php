...
class Channel extends CI_Controller {
	...
	{
		$this->load->view('channel',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->columns('id_channel2','name','big','id_dist');
			$crud->fields('id_channel2','name','big','id_dist');
			$crud->set_relation('id_dist','distributor','code');
			$crud->set_relation('big','big_channel','name');
			$crud->required_fields('id_channel2','name','big','id_dist');
			...
			$crud->unset_print();
			$crud->unset_clone();
			$crud->field_type("id_channel2","integer");
			$crud->display_as('id_channel2','ID Channel');
...
//			$crud->field_type('big','dropdown',array('1' => '1 HOSPITAL', '2' => '2 PHARMACY','3' => '3 DRUGSTORE', '4' => '4 INSTITUTION','5' => '5 MTC','6' => '6 PHARMA CHAIN','7' => '7 GT&OTHERS','8' => '8 PBF'));			
			$crud->display_as('big','Big Channel');
