...
class KPKReportList extends CI_Controller {
	...
	{
		$this->load->view('kpk-reportlist',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_table('kpklist');
			$crud->set_subject('KPK REPORT');
...
//			$crud->field_type('month','dropdown',array('1' => 'January','2' => 'February', '3' => 'Maret', '4' => 'April', '5' => 'Mei', '6' => 'Juni', '7' => 'July', '8' => 'Agustus', '9' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Desember'));			
    ...
    public function _callback_action2($value, $row)
    {
        ...
        $button="<a type='button' id='".$name."' class='btn btn-success btn-xs' target='_blank' href='".base_url()."index.php/KPKReport?year=".$row->year."&month=".$row->month."'>Edit</a>";
