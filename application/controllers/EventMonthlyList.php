...
class EventMonthlyList extends CI_Controller {
	...
	public function index()
	{
		try{
			...
			$crud->set_subject('Event OTC Monthly Report');
...
//			$crud->field_type('month','dropdown',array('1' => 'January','2' => 'February', '3' => 'Maret', '4' => 'April', '5' => 'Mei', '6' => 'Juni', '7' => 'July', '8' => 'Agustus', '9' => 'September', '10' => 'Oktober', '11' => 'November', '12' => 'Desember'));			
    ...
    public function _callback_action2($value, $row)
    {
        ...
        $button="<a type='button' id='".$name."' class='btn btn-success btn-xs' target='_blank' href='".base_url()."index.php/EventMonthly?year=".$row->year."&month=".$row->month."'>View</a>";
