...
class Channel2 extends CI_Controller {
	...
	{
		$this->load->view('channel2',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_table('channel2');
			$crud->set_subject('Internal Channel');
			$crud->columns('name','big');
			$crud->fields('name','big');
			$crud->required_fields('name','big');
