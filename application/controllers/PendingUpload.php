...
class PendingUpload extends CI_Controller {
	...
	{
		$this->load->view('pending_upload',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_table('pending_upload');
			$crud->set_subject('Pending Upload');
			$crud->columns('id','type','id_upload');

			if($this->uri->segment(3)=="id_upload")
			{	
			...
			$crud->field_type('type', 'dropdown',array('1'=>'Branch','2'=>'Customer','3'=>'Product','4'=>'Channel'));
