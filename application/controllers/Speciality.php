...
class Speciality extends CI_Controller {
	...
	{
		$this->load->view('speciality',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_table('speciality');
			$crud->set_subject('Speciality');
			$crud->columns('name_speciality');
			...
			$crud->unset_print();
			$crud->unset_clone();
			$crud->display_as('name_speciality','Speciality');
