...
class ProductDist extends CI_Controller {
	...
	{
		$this->load->view('product_dist',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->set_table('product_dist');
			$crud->set_subject('Product Distributor');
			$crud->columns('id_product3','id_dist','id_product');
			$crud->required_fields('id_product3','id_dist','id_product');
			$crud->fields('id_product3','id_dist','id_product');
			$crud->set_relation('id_dist','distributor','code');
			$crud->set_relation('id_product','product','name_product');
			...
			$crud->unset_print();
			$crud->unset_clone();
			$crud->display_as('id_product3','Distributor Product ID');
