...
class Distributor extends CI_Controller {
	...
	{
		$this->load->view('distributor',(array)$output);
	}
	...
	public function index()
	{
		try{
			...
			$crud->columns('code','name','address','pic','phone','email');
			$crud->fields('code','name','address','pic','phone','email');
			$crud->required_fields('code','name','address');
