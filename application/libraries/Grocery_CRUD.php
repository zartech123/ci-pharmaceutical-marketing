...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_date_input($field_info,$value)
	{
		...
		/*$input = "<div class='input-group'><input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$date' maxlength='10' class='datepicker-input form-control' />
		<a class='datepicker-input-clear' tabindex='-1'>".$this->l('form_button_clear')."</a> <i>&nbsp;".$this->ui_date_format." </i></div>";*/
		$input = "<div class='input-group'><input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$date' maxlength='10' class='datepicker-input form-control' /></div>";
		return $input;
	}
	...
	protected function get_relation_n_n_input($field_info_type, $selected_values)
	{
		...
		else
		{
			...
			$width_style = $has_priority_field || $is_ie_7 ? '' : 'width:auto;';
...
if(defined('CI_VERSION'))
{
	...
	class grocery_CRUD_Form_validation extends CI_Form_validation{
		...
		public $_error_prefix		= '<p><li class=\'list-group-item list-group-item-info\'>';
		public $_error_suffix		= '</li></p>';
		public $error_string		= '';
