                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-info  btn-xs" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <a class="btn btn-success btn-xs t5 gc-export" data-url="<?php echo $export_url; ?>">
                                ...
                                <?php } ?>
                                <?php if(!$unset_print) { ?>
                                    <a class="btn btn-info btn-xs t5 gc-print" data-url="<?php echo $print_url; ?>">
                                ...
                                <a class="btn btn-primary btn-xs search-button t5">
        					...
        					<thead>
        						<tr>
                                    <?php foreach($columns as $column){?>
                                        <th class="column-with-ordering" data-order-by="<?php echo $column->field_name; ?>" style="font-size:12px;font-style:bold;color: #245269;"><?php echo $column->display_as; ?></th>
                                    <?php }?>
        							<th colspan="2" <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?> style="font-size:13px;color: #245269;">
                                        <center><?php echo $this->l('list_actions'); ?></center>
                                    </th>
        						</tr>
        						...
        						<tr class="filter-row gc-search-row">
                                    <?php foreach($columns as $column){?>
                                        <td style="background-color:#ececec;">
                                            <input style="font-size:11px;height:28px" type="text"
                                    ...
                                    <?php }?>
        							<td class="no-border-right <?php if ($buttons_counter === 0) {?>hidden<?php }?>" style="background-color:#ececec">
                                        <?php if (!$unset_delete) { ?>
            							     <div class="floatL t5">
        							...
        							<td class="no-border-left <?php if ($buttons_counter === 0) {?>hidden<?php }?>" style="background-color:#ececec">
                                        <div class="floatL">
                                            <a href="javascript:void(0);" title="<?php echo $this->l('list_delete')?>"
                                               class="hidden btn btn-default btn-xs delete-selected-button">
                                                <i class="fa fa-trash-o text-danger"></i>
                                                <span class="text-danger"><?php echo $this->l('list_delete')?></span>
                                            </a>
                                        </div>
                                        <div class="floatR l5">
                                            <a href="javascript:void(0);" class="btn btn-default btn-xs gc-refresh">
        					...
        					<div class="footer-tools">
                                            ...
                                            <div class="floatR r5">
                                                ...
                                                <div class="btn-group floatR t20 l10 settings-button-container">
                                                    <button type="button" class="btn btn-default btn-xs gc-bootstrap-dropdown settings-button dropdown-toggle">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default btn-xs" data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
                            <button type="button" class="btn btn-danger btn-xs delete-confirmation-button"><?php echo $this->l('list_delete'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger btn-xs delete-multiple-confirmation-button"
